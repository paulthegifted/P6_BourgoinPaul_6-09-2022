...
const { Product } = require("../models/sauceschema")
...
//récuperation sauces
  ...
  //update et envoie réponse a chaque modification de la sauce
  ...
  // fonction gerant la creation de sauce
...
function incrementLike(product, userId, like) {
  ...
  module.exports = { getSauces, createSauce,  getSaucesById,  deleteSauce,  modifSauce, sendClientResponse, likeSauce }